...
public class ProductController {
    ...
    @GetMapping(EshopEndpoint.PRODUCT_ROOT_PATH)
    ...
    @PostMapping(EshopEndpoint.PRODUCT_ROOT_PATH)
    public String createProduct(Model model, @Valid ProductDto product,
        ...
        return "redirect:" + EshopEndpoint.PRODUCT_ROOT_PATH;
    }

    @GetMapping(EshopEndpoint.PRODUCT_LIST_PATH)
    ...
    @GetMapping(EshopEndpoint.PRODUCT_UPDATE_PATH)
    ...
    @PostMapping(EshopEndpoint.PRODUCT_UPDATE_PATH)
    ...
    @PostMapping(EshopEndpoint.PRODUCT_DELETE_PATH)
